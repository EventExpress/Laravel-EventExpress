                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('agendado.update', $agendado->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" id="data_inicio" name="data_inicio" value="{{ old('data_inicio', $agendado->data_inicio) }}" class="form-input mt-1 block w-full" required>
                        </div>

                        <div class="mb-4">
                            <label for="data_fim" class="block text-sm font-medium text-orange-500">Data de Fim:</label>
                            <input type="datetime-local" id="data_fim" name="data_fim" value="{{ old('data_fim', $agendado->data_fim) }}" class="form-input mt-1 block w-full" required>
                        </div>

                        <div class="mb-4">
                            <label for="adicionalId" class="block text-sm font-medium text-orange-500">Escolher adicional:</label>
                            <select name="adicionalId[]" id="adicionalId" multiple class="form-multiselect mt-1 block w-full">
                        ...
                        <div class="mt-6">
                            <button type="submit" class="bg-gray-700 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Salvar Alterações</button>
                        </div>
                    </form>
                </div>
            </div>
