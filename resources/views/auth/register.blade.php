<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Nome -->
        <div>
            <x-input-label for="nome" :value="__('Nome')" class="text-orange-500"/>
        ...
        <!-- Telefone -->
        <div class="mt-4">
            <x-input-label for="telefone" :value="__('Telefone')" class="text-orange-500"/>
        ...
        <!-- Data de Nascimento -->
        <div class="mt-4">
            <x-input-label for="datanasc" :value="__('Data de Nascimento')" class="text-orange-500" />
        ...
        <div>
            <label for="tipousu" class="block text-sm font-medium text-orange-500" >Tipo de Usuário</label>
        ...
        <!-- CPF -->
        <div class="mt-4">
            <x-input-label for="cpf" :value="__('CPF')" class="text-orange-500"/>
        ...
        <div id="cnpjField" class="mt-4" style="display: {{ old('tipousu') === 'Locador' ? 'block' : 'none' }}">
            <x-input-label for="cnpj" :value="__('CNPJ')" class="text-orange-500" />
        ...
        <!-- Cidade -->
        <div class="mt-4">
            <x-input-label for="cidade" :value="__('Cidade')" class="text-orange-500"/>
        ...
        <!-- CEP -->
        <div class="mt-4">
            <x-input-label for="cep" :value="__('CEP')" class="text-orange-500" />
        ...
        <!-- Número -->
        <div class="mt-4">
            <x-input-label for="numero" :value="__('Número')" class="text-orange-500" />
        ...
        <!-- Bairro -->
        <div class="mt-4">
            <x-input-label for="bairro" :value="__('Bairro')" class="text-orange-500" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('Confirmar Senha')" class="text-orange-500" />
            <x-text-input id="password_confirmation" class="block mt-1 w-full" type="password" name="password_confirmation" required />
            <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
        </div>

        <div class="flex items-center justify-end mt-4" >
            <a class="underline text-sm text-orange-500 dark:text-orange-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('login') }}">
